...
#                                                                             
# PROGRAMMER: Tanvi Kapil
# DATE CREATED: 12th November 2023                                  
# REVISED DATE: 
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        #           increments 'n_correct_breed' by 1
        #         'n_correct_breed' is a key in the results_stats_dic dictionary with it's value 
        ...
        #           CODE that counts how many pet images 
        ...
        #           conditional statement that determines when the classifier label indicates the image 
        #           is-NOT-a-dog and then increments 'n_correct_notdogs' by 1. 
        #           The 'else:' above 'pass' already indicates that the 
    ...
    #           matched images. This can be calculated by the
